...
from ansible_collections.extremenetworks.voss.tests.unit.compat.mock import patch, MagicMock
from ansible_collections.extremenetworks.voss.tests.unit.modules.utils import set_module_args
from ansible_collections.extremenetworks.voss.plugins.modules import voss_config
from ansible_collections.extremenetworks.voss.plugins.cliconf.voss import Cliconf
...
class TestVossConfigModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.extremenetworks.voss.plugins.modules.voss_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_get_connection = patch('ansible_collections.extremenetworks.voss.plugins.modules.voss_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('ansible_collections.extremenetworks.voss.plugins.modules.voss_config.run_commands')
